...
class CMSSync:
    ...
    @staticmethod
    def qa_table(query):
        test_cases_dbinfo = {'host': DATABASE_HOST, 'user': DATABASE_USER, 'password': DATABASE_PASSWORD,
                             'port': DATABASE_PORT, 'dbname': DATABASE_MYSQL_GO}
    ...
    def big_data_table(query):
        big_data_dbinfo = {'host': CMS_HOST, 'user': CMS_USER, 'password': CMS_PASSWORD,
                           'port': CMS_PORT, 'dbname': CMS_DB}
